...
Actor::render(DeviceContext& deviceContext) {
	...
	for (unsigned int i = 0; i < m_meshes.size(); i++) {
		...
		// NOTA: Ajusta el slot (1 o 2) según tu Shader. Pandora usaba 2 en Wildvine y 1 en Pandora. 
		// Aquí lo dejo en 2 como en Wildvine, cámbialo a 1 si tu shader usa register(b1).
